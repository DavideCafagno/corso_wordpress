jQuery(document).ready(function ($) {
    if ($('#taxonomy-tipologia_persona').length > 0) {
        $('#taxonomy-tipologia_persona>.tabs-panel').eq(1).prepend('<span class="searchTaxonomyGTdiv"><label for="#searchTaxonomyGT">Cerca: </label><input type="text" value="" id="searchTaxonomyGT" style="border-radius: 10px;font-size: 11px;margin: 5px;"/><br/></span>');
